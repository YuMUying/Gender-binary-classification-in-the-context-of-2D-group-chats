 ...
 *     --from-uid 0 --to-uid 0 --to-nickname 星辞
 *
...
if (!since || !fromUid || !toUid) {
  console.error('用法: node scripts/remap-forward-user.js --since "2026-08-17T11:50:00+08:00" --from-uid 0 --to-uid 0 --to-nickname 星辞');
