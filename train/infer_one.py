...
MODEL_DIR = os.environ.get("QQBOT_MODEL_DIR") or os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "..", "models", "bert-v10-wb-fix")
"""生产模型: bert-v10-wb-fix（wb 的翻转向修复重训，与静态表 p_bert-v10-wb 及
infer.js 阈值 0.73 同源同标定）。换模型请用环境变量 QQBOT_MODEL_DIR 覆盖。"""
