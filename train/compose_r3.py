...
# SM+2: 呜喵～, ?(厚度top2)
# M+2: 江墨白, 酒神爵 (排除用户本人U1814与语体重叠的U2118)
# val扩容 v3 (2026-09-03): F 5->9人 (补班群课业腔2人 + 乙女群交易腔2人)
# 锁定协议: 原5人不动; 旧15人口径历史数字已存档, 新口径起全量重测
# 新增: 邵鉴楠U1546(课业腔) 彭斓U983(课业+私聊) ReiU056(乙女交易腔) minuoU807(乙女日常)
# val v4 / s0v5.4 (2026-09-04): 干净val裁决局
# 移除: 言葉U643+神樱汐梦U1048(faudit降级unknown, val残留1192条假F) + minuoU807(33条太薄)
# 补位: 唐杨雯菲U2078(老乡群现实同学腔654条) + XafubU228(绘旅人310条, 乙女群补位·用户授权自行定)
VAL_FEMALE = [U2099, U2071, U1757,
              U1546, U983, U056, U2078, U228]
VAL_SOFT = [U1485, U432, U1773, U1014, U1360]  # U1063苍中蓝实为女性已移出(2026-09-02), 换U1360迷迭香
VAL_MALE = [U1328, U1808, U2599, U1990, U891]
