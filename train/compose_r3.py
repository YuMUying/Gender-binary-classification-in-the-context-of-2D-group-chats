...
# SM+2: 呜喵～, ?(厚度top2)
# M+2: 江墨白, 酒神爵 (排除用户本人U1890与语体重叠的U2210)
# val扩容 v3 (2026-09-03): F 5->9人 (补班群课业腔2人 + 乙女群交易腔2人)
# 锁定协议: 原5人不动; 旧15人口径历史数字已存档, 新口径起全量重测
# 新增: 邵鉴楠U1610(课业腔) 彭斓U1020(课业+私聊) ReiU058(乙女交易腔) minuoU835(乙女日常)
# val v4 / s0v5.4 (2026-09-04): 干净val裁决局
# 移除: 言葉U667+神樱汐梦U1091(faudit降级unknown, val残留1192条假F) + minuoU835(33条太薄)
# 补位: 唐杨雯菲U2168(老乡群现实同学腔654条) + XafubU239(绘旅人310条, 乙女群补位·用户授权自行定)
VAL_FEMALE = [U2189, U2161, U1831,
              U1610, U1020, U058, U2168, U239]
VAL_SOFT = [U1549, U446, U1847, U1055, U1416]  # U1106苍中蓝实为女性已移出(2026-09-02), 换U1416迷迭香
VAL_MALE = [U1382, U1883, U2719, U2075, U923]
